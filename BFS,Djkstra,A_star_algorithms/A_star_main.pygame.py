# Standalone Coder. Алгоритм A-star (A*).
# A_star_main_file
...
def heuristic(a, b):
    """
    Эвристическая функция определения Манхэттенского расстояния.
    Определяет на сколько проложенный маршрут близок к цели.
    """
...
pg.display.set_caption("A_star algorithm")
clock = pg.time.Clock()
FPS = 7
...
game_bg = pg.transform.scale(game_bg, (cols * TILE, rows * TILE))
